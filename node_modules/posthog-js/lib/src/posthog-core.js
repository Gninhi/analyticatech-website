...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._initExtensions = function (startInCookielessMode) {
        ...
        if (ext.tracingHeaders) {
            initTasks.push(function () {
                new ext.tracingHeaders(_this).startIfEnabledOrStop();
            });
        }
        if (ext.siteApps) {
            initTasks.push(function () {
                var _a;
                _this.siteApps = new ext.siteApps(_this);
                (_a = _this.siteApps) === null || _a === void 0 ? void 0 : _a.init();
            });
        }
        if (!startInCookielessMode && ext.sessionRecording) {
            initTasks.push(function () {
                _this.sessionRecording = new ext.sessionRecording(_this);
        ...
        if (ext.autocapture) {
            initTasks.push(function () {
                _this.autocapture = new ext.autocapture(_this);
        ...
        if (ext.productTours) {
            initTasks.push(function () {
                _this.productTours = new ext.productTours(_this);
                _this.productTours.loadIfEnabled();
            });
        }
        if (ext.heatmaps) {
            initTasks.push(function () {
                _this.heatmaps = new ext.heatmaps(_this);
                _this.heatmaps.startIfEnabled();
            });
        }
        if (ext.webVitalsAutocapture) {
            initTasks.push(function () {
                _this.webVitalsAutocapture = new ext.webVitalsAutocapture(_this);
            });
        }
        if (ext.exceptionObserver) {
            initTasks.push(function () {
                _this.exceptionObserver = new ext.exceptionObserver(_this);
                _this.exceptionObserver.startIfEnabledOrStop();
            });
        }
        if (ext.deadClicksAutocapture) {
            initTasks.push(function () {
                _this.deadClicksAutocapture = new ext.deadClicksAutocapture(_this, dead_clicks_autocapture_1.isDeadClicksEnabledForAutocapture);
                _this.deadClicksAutocapture.startIfEnabledOrStop();
            });
        }
    ...
    PostHog.prototype.reset = function (reset_device_id) {
        ...
        (_c = this._remoteConfigLoader) === null || _c === void 0 ? void 0 : _c.stop();
        this.featureFlags.reset();
        (_d = this.persistence) === null || _d === void 0 ? void 0 : _d.set_property(constants_1.USER_STATE, 'anonymous');
    ...
    PostHog.prototype.set_config = function (config) {
        ...
        if ((0, core_1.isObject)(config)) {
            ...
            (_h = this.externalIntegrations) === null || _h === void 0 ? void 0 : _h.startIfEnabledOrStop();
        }
    };
    /**
    ...
    PostHog.prototype.opt_in_capturing = function (options) {
        ...
        if (this.config.cookieless_mode === 'on_reject' && this.consent.isExplicitlyOptedOut()) {
            ...
            if (SessionRecordingClass) {
                this.sessionRecording = new SessionRecordingClass(this);
        ...
        if ((0, core_1.isUndefined)(options === null || options === void 0 ? void 0 : options.captureEventName) || (options === null || options === void 0 ? void 0 : options.captureEventName)) {
            this.capture((_g = options === null || options === void 0 ? void 0 : options.captureEventName) !== null && _g !== void 0 ? _g : '$opt_in', options === null || options === void 0 ? void 0 : options.captureProperties, { send_instantly: true });
        }
        if (this.config.capture_pageview) {
