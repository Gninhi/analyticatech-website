...
var sendSurveyEvent = function (_a) {
    var _b, _c;
    var _d;
    var responses = _a.responses, survey = _a.survey, surveySubmissionId = _a.surveySubmissionId, posthog = _a.posthog, isSurveyCompleted = _a.isSurveyCompleted, properties = _a.properties;
    if (!posthog) {
    ...
    }); }), _b[posthog_surveys_types_1.SurveyEventProperties.SURVEY_SUBMISSION_ID] = surveySubmissionId, _b[posthog_surveys_types_1.SurveyEventProperties.SURVEY_COMPLETED] = isSurveyCompleted, _b.sessionRecordingUrl = (_d = posthog.get_session_replay_url) === null || _d === void 0 ? void 0 : _d.call(posthog), _b), responses), properties), { $set: (_c = {},
...
var dismissedSurveyEvent = function (survey, posthog, readOnly) {
    ...
    posthog.capture(posthog_surveys_types_1.SurveyEventName.DISMISSED, __assign(__assign({}, _buildSurveyEventProperties(survey, inProgressSurvey, posthog)), { $set: (_a = {},
            _a[(0, survey_utils_1.getSurveyInteractionProperty)(survey, 'dismissed')] = true,
            _a) }));
    (0, exports.clearInProgressSurveyState)(survey);
    (0, survey_utils_1.setSurveySeenOnLocalStorage)(survey);
